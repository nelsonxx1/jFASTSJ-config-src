...
public class ActualizarReportes {
    ...
    public ActualizarReportes() {
        ...
        list.add(new Reporte(Dominios.CategoriaReporte.SINIESTROS, 0, "SIN-R001", "Listado de Diagnosticos Sinoiestros de Pago por Remesa", "Agrupados por Remesa, Nombre de Persona a Pagar", "SELECT P.diagnostico as diagnostico, P.montoPagado as montoPagado FROM com.jswitch.siniestros.modelo.maestra.DiagnosticoSiniestro as P WHERE P.id=30921 ORDER BY P.diagnostico.nombre", "Carta 8½ x 11 Vertical", false, true, false, false));
